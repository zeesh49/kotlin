...
public interface KtNodeTypes {
    ...
    IElementType CONSTRUCTOR_DELEGATION_CALL = new KtNodeType.KtLeftNodeType("CONSTRUCTOR_DELEGATION_CALL", KtConstructorDelegationCall.class);
    KtNodeType CONSTRUCTOR_DELEGATION_REFERENCE = new KtNodeType.KtLeftNodeType("CONSTRUCTOR_DELEGATION_REFERENCE", KtConstructorDelegationReferenceExpression.class);
