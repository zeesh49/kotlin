...
class FoldTryCatchToAssignmentFix(element: KtTryExpression): KotlinQuickFixAction<KtTryExpression>(element) {
    override fun getFamilyName() = text

    override fun getText() = "Replace 'try' expression with assignment"
    ...
    companion object : KotlinSingleIntentionActionFactory() {
        ...
        override fun createAction(diagnostic: Diagnostic): IntentionAction? {
            ...
            return FoldTryCatchToAssignmentFix(tryExpression)
        }
    }
}